                                ...
                                <tbody>
                                    <?php foreach ($brand_list as $brand) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$brand->order->count()}}</td>
                                            <td>{{$brand->order->where('order_status','selesai')->count()}}</td>
                                            <td>{{$brand->order->where('order_status','batal')->count()}}</td>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('accesories', $brand->id) }}" method="GET" style='float: left; padding-top: 30px'>
                                                    {{ csrf_field() }}
                                                    <button type="submit" class="btn btn-success">Detail Accesories</button>
                                                </form>
